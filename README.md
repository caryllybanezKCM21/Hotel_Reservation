...
<head>
  ...
  background: #f3f6fb;       /* subtle background */
}
...
/* container stretches full width */
#appContainer {
  width: 100%;
  margin: 0;
  padding: 0;
...
/* app grid layout: sidebar fixed, content fills remaining width */
.app {
  display: grid;
  grid-template-columns: 240px 1fr; /* sidebar fixed 240px, content fills rest */
  gap: 18px;
  margin-top: 18px;
  ...
  <div id="signInSection">
    <form class="signin-box" id="signInForm">
      ...
      <div style="display:flex;gap:8px;justify-content:flex-end;margin-top:6px">
        <button type="button" class="btn btn-ghost" id="openRegisterBtn">Register</button>
...
function bindUI(){
  document.getElementById('signInForm').addEventListener('submit', function(e){
    ...
    frontPageSignIn(); // your existing sign-in function
});
